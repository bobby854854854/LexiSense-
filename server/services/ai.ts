  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a legal contract analyzer. Analyze the contract and return a JSON object with summary, risks, parties, and dates.'
        },
        {
          role: 'user',
  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a legal assistant. Answer questions about the provided contract.'
        },
        {
          role: 'user',
